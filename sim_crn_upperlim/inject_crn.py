...
efac=1 and also a spatiallly uncorrelated GWB with amplitude 2.4e-15. Then it
fits for the par file with the TOAs after the injection, and saves the fitted par
file and tim file.
"""
